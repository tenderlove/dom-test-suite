	...
	public static final DocumentBuilderSettingStrategy schemaValidating =
		...
		public void applySetting(DocumentBuilderFactory factory, boolean value)
			...
			if (value) {
				...
				factory.setAttribute(JAXP_SCHEMA_LANGUAGE, "http://www.w3.org/TR/REC-xml");				
			}
		}
		public boolean hasSetting(DOMTestDocumentBuilderFactory factory) {
			try {
				if (factory.isValidating()) {
					Method getAttrMethod = factory.getClass().getMethod("getAttribute", new Class[] { String.class });
					String val = (String) getAttrMethod.invoke(factory, new Object[] { JAXP_SCHEMA_LANGUAGE });
