...
public class XercesHTML2DocumentBuilderFactory
   ...
   */
  public XercesHTML2DocumentBuilderFactory(
...
//        settings[i].applySetting(factory);
  ...
  private class HTMLHandler extends DefaultHandler implements AttributeList {
    ...
    public HTMLHandler(Constructor htmlBuilderConstructor,
      Method getHTMLDocumentMethod) throws Exception {
      htmlBuilder = (DocumentHandler) htmlBuilderConstructor.newInstance(new Object[0]);
    ...
    public Document getHTMLDocument() throws Exception {
       return (Document) getHTMLDocumentMethod.invoke(htmlBuilder, NO_OBJECTS);
    }
  ...
  public Document load(java.net.URL url) throws DOMTestLoadException {
    ...
    try {
      ...
      HTMLHandler handler = new HTMLHandler(
        htmlBuilderConstructor,getHTMLDocumentMethod);
