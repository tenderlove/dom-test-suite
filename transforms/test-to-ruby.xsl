...
<xsl:text># see[</xsl:text><xsl:value-of select="@resource"/><xsl:text>]
</xsl:text>
</xsl:for-each>
...
<xsl:text>DOMTestCase('</xsl:text><xsl:value-of select="@name"/>
    <xsl:text>') do
...
<xsl:text>
  ...
  #
  def test_</xsl:text><xsl:value-of select="@name"/><xsl:text>
    </xsl:text>
...
<xsl:template match="*[local-name()='assertNotNull']" mode="body">
    <xsl:param name="vardefs"/>
    <xsl:text>assert_not_nil(</xsl:text><xsl:value-of select="@actual"/>
    <xsl:text>, "</xsl:text>
    <xsl:value-of select="@id"/>
    <xsl:text>")
      </xsl:text>
